...
class RespuestaSolicitudEtiquetaRefCli extends AbstractStructBase
{
     ...
     */
    public function __construct($codExpedicion = null, $fechaRespuesta = null, $resultado = null, $totalBultos = null, DATOSBULTOTYPE $bulto = null, DATOSBULTOERRORTYPE $bultoError = null)
    {
        $this
     ...
     * @param string $codExpedicion
     * @return RespuestaSolicitudEtiquetaRefCli
     */
